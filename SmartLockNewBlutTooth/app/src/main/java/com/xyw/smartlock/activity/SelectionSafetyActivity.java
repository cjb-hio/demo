...
public class SelectionSafetyActivity extends Activity {
...
//                }
                ...
                SelectionSafetyActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
                SelectionSafetyActivity.this.finish();
            }
        });
    ...
    private void VolleyGet() {
        try {
            //等待网络的D
            dialog = new LoadingDialog(SelectionSafetyActivity.this, R.style.dailogStyle);
            dialog.show();
