...
public class SelectionUnitActivity extends Activity {
    ...
    private void initView() {
        ...
        selection_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SelectionUnitActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
    ...
    private void VolleyGet() {
        ...
        try {
            //等待网络的D
            dialog = new LoadingDialog(SelectionUnitActivity.this, R.style.dailogStyle);
            dialog.show();
