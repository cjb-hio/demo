...
public class QueryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unlockrecord_customdialog);
        TextView customdialog_title = (TextView)findViewById(R.id.unlockrecord__customdialog_title);
        customdialog_title.setText(R.string.choose_date);
        unlockrecord_button1 = (Button) findViewById(R.id.unlockrecord_button1);
        unlockrecord_button2 = (Button) findViewById(R.id.unlockrecord_button2);
        unlockrecord_startDate = (TextView) findViewById(R.id.unlockrecord_textview1);
        unlockrecord_endDate = (TextView) findViewById(R.id.unlockrecord_textview2);
        ed_id = (EditText) findViewById(R.id.ed_id);
        user = (TextView) findViewById(R.id.ed_quer_user);
        ...
        unlockrecord_startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(QueryActivity.this, mDateSetListener, mYear, mMonth, mDay).show();
            }
        });
        unlockrecord_endDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(QueryActivity.this, mDateSetListener1, mYear1, mMonth1, mDay1).show();
            }
        });
        ...
        unlockrecord_button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("ed_id",ed_id.getText().toString());

                QueryActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
    ...
    public void toSelectUser(View view) {
        startActivityForResult(new Intent(QueryActivity.this, SelectUserrActivity.class), 1);
    }
