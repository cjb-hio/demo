...
public class SelectionTrafficActivity extends Activity {
...
//                }
                ...
                SelectionTrafficActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
                SelectionTrafficActivity.this.finish();
            }
        });
    ...
    private void VolleyGet() {
        ...
        try {
            //等待网络的D
            dialog = new LoadingDialog(SelectionTrafficActivity.this, R.style.dailogStyle);
            dialog.show();
