...
public class SelectionProductionActivity extends Activity {
...
//                }
                ...
                SelectionProductionActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
                SelectionProductionActivity.this.finish();
            }
        });
    ...
    private void VolleyGet() {
        ...
        try {
            //等待网络的D
            dialog = new LoadingDialog(SelectionProductionActivity.this, R.style.dailogStyle);
            dialog.show();
