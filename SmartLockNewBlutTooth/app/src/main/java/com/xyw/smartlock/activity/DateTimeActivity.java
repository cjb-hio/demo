    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockrecord_startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(DateTimeActivity.this, mDateSetListener, mYear, mMonth, mDay).show();
            }
        });
        unlockrecord_endDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(DateTimeActivity.this, mDateSetListener1, mYear1, mMonth1, mDay1).show();
            }
        });
        startDate();
        endDate();
        unlockrecord_button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DateTimeActivity.this.setResult(RESULT_OK, intent);
                // 关闭Activity
