...
public class PDALockRegistersdChildMeterActivity extends AppCompatActivity implements View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateBaseUtil = new DateBaseUtil(PDALockRegistersdChildMeterActivity.this);
...
//			Log.e("down", ""+keyDown);
    ...
    private void showData(String barcode) {
        switch (qrcodeOnFocus) {
            case SCANNIN_GREQUEST_CODE1:
                ...
                if (!mScanList.contains(meterOne)) {
                    ...
                    Toast.makeText(PDALockRegistersdChildMeterActivity.this, R.string.data_contains, Toast.LENGTH_SHORT).show();
...
//                        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    private void initview() {
        ...
        dialog = new LoadingDialog(PDALockRegistersdChildMeterActivity.this, R.style.dailogStyle);
...
//                scan();
        ...
        childMeter_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkLast()) {
                    if (ActivityUtils.getInstance().isNetworkAvailable(PDALockRegistersdChildMeterActivity.this)) {
                        if (checkData()) {
                            map = null;
                            if (type == REGISTER_METER) {
                                volley_post();
...
//                                volley_update();
                            ...
                            Toast.makeText(PDALockRegistersdChildMeterActivity.this, "存在相同数据", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(PDALockRegistersdChildMeterActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
//                            insertSqlite();
                    }
                }
            }
...
//            querySqlite();
    ...
    private String meterOne = "", meterTwo = "", meterThree = "", meterFour = "", meterFive = "", meterSix = "", meterSeven = "", meterEight = "",
            meterNine = "", meterTen = "", meterEle = "", meterTwe = "", meterThi = "", meterFou = "", meterFif = "";
    private String meterSixt = "", meterSev = "", meterEig = "", meterNin = "", meterTwen = "", meterTone = "", meterTtwo = "", meterTthr = "",
            meterTfou = "", meterTfiv = "", meterTsix = "", meterTsev = "", meterTeig = "", meterTnin = "", meterThir = "";
...
//                            }
                            Toast.makeText(PDALockRegistersdChildMeterActivity.this, "上传成功", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent();
                            PDALockRegistersdChildMeterActivity.this.setResult(RESULT_OK, intent);
                            PDALockRegistersdChildMeterActivity.this.finish();
                        } else {
                            ToastUtil.MyToast(PDALockRegistersdChildMeterActivity.this, "上传失败，请重新上传");
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        dialog.dismiss();
                        ToastUtil.MyToast(PDALockRegistersdChildMeterActivity.this, strResult);
                    }
...
//                                dateBaseUtil.delete4(lockID);
//                            }
                            Toast.makeText(PDALockRegistersdChildMeterActivity.this, "更新成功", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent();
                            PDALockRegistersdChildMeterActivity.this.setResult(RESULT_OK, intent);
                            PDALockRegistersdChildMeterActivity.this.finish();
                        } else {
